...
C_CPP_LIBR 			= libc libgcc


# Compiler name and compilation flags
CC                 	= ldc2
CFLAGS              = -mtriple=thumb-none-linux-eabi -c -betterC -relocation-model=pic -Os -I$(D_LIBTOCK)/ -I/usr/import/
...
$$(BUILD_DIR)/$(1)/$(1).elf: $(OBJS)
	@$(LD) -mcpu=$(1) $(LDFLAGS) $(OBJS) $$(LIBS_$(1)) $(STD_LIBR) -Wl,-Map=$(BUILD_DIR)/$(1)/$(1).Map -o $$@
endef
